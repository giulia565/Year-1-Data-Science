...
title: | 
  ...
  | 2022-2023
author: |
  | Your Name: Giulia Gay
  | your email: g.gay@student.uu.nl
...
GrowthSW$treat <-ifelse (GrowthSW$revolutions ==0, 0, 1)
...
Giulia has a data table that shows the mean, median, sd, min, and max for the variables growth and rgdp60 for countries with revolutions and with no revolutions.
...
```{r}
library(ggplot2)
t.test(growth ~ treat, data = GrowthSW, var.equal = FALSE, paired = FALSE)
